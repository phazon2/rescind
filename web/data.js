window.RESCIND_DATA = {
  "recorded_from": {
    ...
    "commit": "f59ac8b461701b04271fea487b8a52dfb8646ed1",
    "run_url": "https://github.com/phazon2/rescind/actions/runs/32083852385",
  ...
  "before": {
    "facts": [
      {
        "id": "1c832589-82cd-47bf-93cb-51e9d4c6afa7",
        "kind": "observation",
      ...
      {
        "id": "1150f612-10b5-4ce6-971a-80b55c5a9e87",
        "kind": "observation",
      ...
      {
        "id": "c42dc211-ca15-4b0c-b237-133b48174e9d",
        "kind": "observation",
      ...
      {
        "id": "53ef4195-f926-4a2e-ae61-e655fd3bf685",
        "kind": "derived",
      ...
      {
        "id": "e087bc51-33e5-43fe-bdb0-6afcc3434a49",
        "kind": "derived",
      ...
      {
        "id": "977ffb9a-9655-46ea-b88f-f4ccde640cd4",
        "kind": "derived",
    ...
    "decision": {
      "id": "6d0f6bd2-e9a9-4b77-9657-06e47f79eeff",
      ...
      "decided_hlc": "1787012204994021377.0000000000",
  ...
  "retraction": {
    "retraction_id": "5eee926c-ae35-432a-909f-214527d7876d",
    ...
    "actor": "d.radrigan",
    "root_fact_ids": [
      "1c832589-82cd-47bf-93cb-51e9d4c6afa7"
    ],
    "retracted_fact_ids": [
      "1c832589-82cd-47bf-93cb-51e9d4c6afa7",
      "977ffb9a-9655-46ea-b88f-f4ccde640cd4",
      "e087bc51-33e5-43fe-bdb0-6afcc3434a49"
    ],
    "facts_retracted": 3,
    "cascade_beyond_roots": 2,
    "decisions_flagged": 1,
    "retracted_hlc": "1787012205002594384.0000000000"
  },
  "after": {
    "facts": [
      {
    ...
    "decision": {
      "id": "81a70346-3bef-461a-a649-bf0f3a96a2ae",
      "question": "May we release lot LOT-2026-0619-NV to Meridian Foods DC-7?",
      "verdict": "refused",
      ...
      "decided_hlc": "1787012205013210510.0000000000",
    ...
    "open_reviews": [
      {
        ...
        "decided_at": "2026-08-18 00:16:44.994005+00:00"
      }
    ]
  },
  "replay": {
  ...
  "lineage": [
    {
      "parent": "c42dc211-ca15-4b0c-b237-133b48174e9d",
      "child": "53ef4195-f926-4a2e-ae61-e655fd3bf685"
    },
    {
      "parent": "53ef4195-f926-4a2e-ae61-e655fd3bf685",
      "child": "977ffb9a-9655-46ea-b88f-f4ccde640cd4"
    },
    {
      "parent": "e087bc51-33e5-43fe-bdb0-6afcc3434a49",
      "child": "977ffb9a-9655-46ea-b88f-f4ccde640cd4"
    },
    {
      "parent": "1150f612-10b5-4ce6-971a-80b55c5a9e87",
      "child": "e087bc51-33e5-43fe-bdb0-6afcc3434a49"
    },
    {
      "parent": "1c832589-82cd-47bf-93cb-51e9d4c6afa7",
      "child": "e087bc51-33e5-43fe-bdb0-6afcc3434a49"
    }
  ]
};
