window.RESCIND_DATA = {
  "recorded_from": {
    ...
    "commit": "86fcbb139596fab2c384139702ef57777f48b15f",
    "run_url": "https://github.com/phazon2/rescind/actions/runs/32072721765",
  ...
  "before": {
    "facts": [
      {
        "id": "d29b0764-fe23-4450-87fd-6d79715038b7",
        "kind": "observation",
      ...
      {
        "id": "71136c92-18d8-45df-ad00-cb5daadca4b7",
        "kind": "observation",
      ...
      {
        "id": "88aee7b2-ceb4-4ebc-908f-73ecea76f200",
        "kind": "observation",
      ...
      {
        "id": "4a6821d7-2b43-437f-a1d1-61407fb7d2e8",
        "kind": "derived",
      ...
      {
        "id": "ffcb7077-c36b-4cbf-8d2c-003b9370d979",
        "kind": "derived",
      ...
      {
        "id": "78a3ffe3-d100-445f-8f75-305c6be1b531",
        "kind": "derived",
    ...
    "decision": {
      "id": "dfc02376-f09e-47ab-a3af-ceb27a8bf9da",
      ...
      "decided_hlc": "1787003149132824504.0000000000",
  ...
  "retraction": {
    "retraction_id": "3b22b749-d4f4-4d5c-9bda-abe90c3f0cb3",
    ...
    "actor": "d.radrigan",
    "root_fact_ids": [
      "d29b0764-fe23-4450-87fd-6d79715038b7"
    ],
    "retracted_fact_ids": [
      "78a3ffe3-d100-445f-8f75-305c6be1b531",
      "d29b0764-fe23-4450-87fd-6d79715038b7",
      "ffcb7077-c36b-4cbf-8d2c-003b9370d979"
    ],
    "facts_retracted": 3,
    "cascade_beyond_roots": 2,
    "decisions_flagged": 1,
    "retracted_hlc": "1787003149141881653.0000000000"
  },
  "after": {
    "facts": [
      {
    ...
    "decision": {
      "id": "f348d8ca-0bf3-4887-b422-55ab009b51ed",
      "question": "May we release lot LOT-2026-0619-NV to Meridian Foods DC-7?",
      "verdict": "refused",
      ...
      "decided_hlc": "1787003149152147881.0000000000",
    ...
    "open_reviews": [
      {
        ...
        "decided_at": "2026-08-17 21:45:49.132810+00:00"
      }
    ]
  },
  "replay": {
  ...
  "lineage": [
    {
      "parent": "88aee7b2-ceb4-4ebc-908f-73ecea76f200",
      "child": "4a6821d7-2b43-437f-a1d1-61407fb7d2e8"
    },
    {
      "parent": "4a6821d7-2b43-437f-a1d1-61407fb7d2e8",
      "child": "78a3ffe3-d100-445f-8f75-305c6be1b531"
    },
    {
      "parent": "ffcb7077-c36b-4cbf-8d2c-003b9370d979",
      "child": "78a3ffe3-d100-445f-8f75-305c6be1b531"
    },
    {
      "parent": "71136c92-18d8-45df-ad00-cb5daadca4b7",
      "child": "ffcb7077-c36b-4cbf-8d2c-003b9370d979"
    },
    {
      "parent": "d29b0764-fe23-4450-87fd-6d79715038b7",
      "child": "ffcb7077-c36b-4cbf-8d2c-003b9370d979"
    }
  ]
};
